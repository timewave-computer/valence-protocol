> 🚧 This in-progress document contains information about the design of a cross-chain automation system that powers the Valence workflows. Lending applications can be implemented as specific "workflow".
