...
contract VaultUpdateTest is VaultHelper {
    ...
    function testUpdateCollectsAndDistributesFees() public {
        ...
        uint256 performanceFees = (yield * 2000) / BASIS_POINTS;
    ...
    function testFeesDistributionRatio() public {
        ...
        uint256 totalFees = (depositAmount * 1000) / BASIS_POINTS; // 10000
    ...
    function testUpdateDistributesDepositFees() public {
        ...
        // Calculate expected fees
        uint256 totalFees = (depositAmount * 500) / BASIS_POINTS; // 5000
    ...
    function testUpdateDistributesMultipleFeeTypes() public {
        ...
        uint256 platformFees = (remainingAssets * 1000) / BASIS_POINTS; // 9500
        
        // Calculate performance fees on the yield
        uint256 yield = (depositAmount * 1000) / BASIS_POINTS; // 9500
        uint256 performanceFees = (yield * 2000) / BASIS_POINTS; // 1900
