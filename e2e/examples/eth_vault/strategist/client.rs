...
use crate::{
    ...
    strategist::bridge::EthereumVaultBridging,
};
...
pub struct Strategist {
    ...
    pub(crate) neutron_program_accounts: NeutronProgramAccounts,
    pub(crate) neutron_program_libraries: NeutronProgramLibraries,
    pub(crate) eth_program_accounts: EthereumProgramAccounts,
    pub(crate) uusdc_on_neutron_denom: String,
    pub(crate) lp_token_denom: String,
    pub(crate) pool_addr: String,
    pub(crate) cctp_transfer_lib: Address,
    pub(crate) vault_addr: Address,
    pub(crate) ethereum_usdc_erc20: Address,
}
