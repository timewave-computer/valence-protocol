...
<<<<<<< HEAD:contracts/libraries/generic-ibc-transfer/README.md
The **Valence Generic IBC Transfer** library allows to transfer funds over IBC from an **input account** on a source chain to an **output account** on a destination chain. It is typically used as part of a **Valence Workflow**. In that context, a **Processor** contract will be the main contract interacting with the Forwarder library.
=======
...
>>>>>>> main:contracts/services/generic-ibc-transfer/README.md
