...
impl SplitterTestSuite {
    ...
    pub fn splitter_init(&mut self, cfg: &LibraryConfig) -> Addr {
    ...
    fn splitter_config(&self, splits: Vec<UncheckedSplitConfig>) -> LibraryConfig {
        LibraryConfig::new(self.input_addr(), splits)
    }
...
impl LibraryTestSuite<Empty, Empty> for SplitterTestSuite {
    fn app(&self) -> &App {
        self.inner.app()
    }
