...
use valence_service_utils::{
    ...
    testing::{CustomServiceTestSuiteBase, ServiceTestSuite},
    ServiceAccountType,
};
...
struct IbcTransferTestSuite {
    #[getset(get)]
    inner: CustomServiceTestSuiteBase<Empty, NeutronQuery>,
    #[getset(get)]
...
impl ServiceTestSuite<Empty, NeutronQuery> for IbcTransferTestSuite {
